...
export const calculatePos = (updatedItemIndex: number, updatedList: Positionable[]): number => {
  let pos
...
export const sortByPos = <T extends Positionable>(assortedArray: T[]): T[] =>
  [...assortedArray].sort((a, b) => (a.pos > b.pos ? 1 : -1))
