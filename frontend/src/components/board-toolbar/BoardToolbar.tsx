...
export default function BoardToolbar() {
  ...
  const newListInputRef = React.useRef<HTMLDivElement>(null)
  ...
  const newListButtonOnClick = () => {
    ...
    setTimeout(() => {
      ...
      const nameInput = newListInputRef.current.children[0] as HTMLInputElement
      nameInput.focus()
    }, 25)
  }
  ...
  const newListNameInputOnKey = (e: React.KeyboardEvent) => {
    switch (e.key) {
    case 'Enter':
      e.preventDefault()
      createNewList()
